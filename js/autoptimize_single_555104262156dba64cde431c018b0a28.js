...
(function ($) {
    ...
    $.maxmegamenu = function (menu, options) {
        ...
        var items_with_submenus = $(
            "li.mega-menu-megamenu.mega-menu-item-has-children,li.mega-menu-flyout.mega-men" +
                    "u-item-has-children,li.mega-menu-tabbed > ul.mega-sub-menu > li.mega-menu-item" +
                    "-has-children,li.mega-menu-flyout li.mega-menu-item-has-children",
            menu
        );
        ...
        plugin.showPanel = function (anchor) {
            anchor
                .parent()
                .triggerHandler("before_open_panel");
            ...
            anchor
                ...
                .triggerHandler("open_panel");
        };
        plugin.hidePanel = function (anchor, immediate) {
            anchor
                .parent()
                .triggerHandler("before_close_panel");
        ...
        var bindClickEvents = function () {
            ...
            var collapse_children_parents = $(
                "li.mega-menu-megamenu li.mega-menu-item-has-children.mega-collapse-children > " +
                "a.mega-menu-link"
            );
        ...
        var bindKeyboardEvents = function () {
            ...
            $menu
                ...
                .on("keyup.megamenu", function (e) {
                    ...
                    if (keyCode === tab_key) {
                        $menu
                            .parent()
                            .addClass("mega-keyboard-navigation");
                    }
                });
            $menu
                .parent()
                ...
                .on("keyup.megamenu", function (e) {
                    ...
                    if (keyCode === escape_key && $menu.parent().hasClass("mega-keyboard-navigation")) {
                        ...
                        if (plugin.isMobileView() && !submenu_open) {
                            ...
                            $(".mega-menu-toggle-block, button.mega-toggle-animated", $toggle_bar)
                                .first()
                                .focus();
                        }
                    }
            ...
            $menu
                .parent()
                .on("focusout.megamenu", function (e) {
                    if ($menu.parent().hasClass("mega-keyboard-navigation")) {
                        setTimeout(function () {
                            var menu_has_focus = $menu
                                .parent()
                                .find(":focus")
                                .length > 0;
                            if (!menu_has_focus) {
                                $menu
                                    .parent()
                                    .removeClass("mega-keyboard-navigation");
                                plugin.hideAllPanels();
                                plugin.hideMobileMenu();
                            }
                        }, 10);
        ...
        plugin.unbindAllEvents = function () {
            $(
                "ul.mega-sub-menu, li.mega-menu-item, li.mega-menu-row, li.mega-menu-column, a." +
        ...
        plugin.unbindClickEvents = function () {
            $("> a.mega-menu-link", items_with_submenus).off(
                "click.megamenu touchend.megamenu"
            );
        };
        ...
        plugin.unbindKeyboardEvents = function () {
            $menu
                .parent()
                .off("keyup.megamenu keydown.megamenu focusout.megamenu");
        };
        ...
        plugin.addClearClassesToMobileItems = function () {
            $(".mega-menu-row", $menu).each(function () {
                $("> .mega-sub-menu > .mega-menu-column:not(.mega-hide-on-mobile)", $(this))
                    .filter(
                        ":even"
                    )
        ...
        plugin.initToggleBar = function () {
            $toggle_bar.on("click", function (e) {
                if ($(e.target).is(
                    ".mega-menu-toggle, .mega-menu-toggle-block, .mega-menu-toggle-animated-block, " +
                    ".mega-menu-toggle-animated-block *, .mega-toggle-blocks-left, .mega-toggle-blo" +
                    "cks-center, .mega-toggle-blocks-right, .mega-toggle-label, .mega-toggle-label " +
                    "span"
                )) {
