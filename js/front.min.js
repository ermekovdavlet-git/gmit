...
function () {
    ...
    n.prototype = {
        add: function () {
            e(arguments, function (e) {
                this.contains(e) || (
                    this.element.className += 0 < this.element.className.length
                        ? " " + e
                        : e
                )
            }, this)
    ...
    "classList" in Element.prototype || Object.defineProperty(
        Element.prototype,
        "classList",
        {
            get: function () {
    ...
    window.DOMTokenList && null == DOMTokenList.prototype.replace && (
    ...
    var e = new function () {
        ...
        this.setStatus = function (e) {
            ...
            "accept" === e
                ? (
                    e = "true",
                    i.setTime(parseInt(n.getTime()) + 1e3 * parseInt(cnArgs.cookieTime))
                )
                : (
                    e = "false",
                    i.setTime(parseInt(n.getTime()) + 1e3 * parseInt(cnArgs.cookieTimeRejected))
                ),
            r.cookie = cnArgs.cookieName + "=" + e + ";expires=" + i.toUTCString() + ";" + (
                cnArgs.cookieDomain
            ...
            if (
                ...
                "automatic" === cnArgs.revokeCookiesOpt && (
                    this.noticeContainer.addEventListener("animationend", function e() {
                        t
                            .noticeContainer
                            .removeEventListener("animationend", e),
                        t.showRevokeNotice()
                    }),
                    this.noticeContainer.addEventListener("webkitAnimationEnd", function e() {
                        t
                            .noticeContainer
                            .removeEventListener("webkitAnimationEnd", e),
                        t.showRevokeNotice()
                    })
                ),
                ...
                "1" === cnArgs.cache
                    ? (s = s + c.replace("//", "/") + (
                        "" === a.location.search
                            ? "?"
                            : a.location.search + "&"
                    ) + "cn-reloaded=1" + a.location.hash, a.location.href = s)
                    : (
                        s = s + c.replace("//", "/") + a.location.search + a.location.hash,
                        a.location.reload(!0)
                    )
            } else ;
            }
        ...
        this.handleScroll = function () {
            (a.pageYOffset || (r.documentElement || r.body.parentNode || r.body).scrollTop) > parseInt(
                cnArgs.onScrollOffset
        ...
        this.adjustOffset = function () {
            ...
            null !== e && (
                n = e.offsetHeight - 1,
                "top" === cnArgs.position
                    ? (e.style.top = i + "px", this.noticeContainer.style.top = n + i + "px")
        ...
        this.init = function () {
            ...
            this
                .noticeContainer
                .classList
                .add("cn-effect-" + cnArgs.hideEffect),
            t.adjustOffset(),
            ...
            "1" === cnArgs.coronabarActive && (
                ...
                r.addEventListener("saveData.coronabar", function (e) {
                    ...
                    if (null !== t) {
                        ...
                        n.onerror = function () {},
                        n.send(
                            "action=cn_save_cases&nonce=" + cnArgs.nonce + "&data=" + JSON.stringify(t)
                        )
                    }
                })
            ),
            null === this.cookiesAccepted
                ? (
                    "1" === cnArgs.onScroll && a.addEventListener("scroll", function (e) {
                        t.handleScroll()
                    }),
                ...
                : (
                    this.setBodyClass([
                        "cookies-set", !0 === this.cookiesAccepted
                            ? "cookies-accepted"
                            : "cookies-refused"
                    ]),
                    "1" === cnArgs.revokeCookies && "automatic" === cnArgs.revokeCookiesOpt && this.showRevokeNotice()
                );
            ...
            for (o = 0; o < n.length; o++) 
                n[o].addEventListener("click", function (e) {
                    ...
                    t
                        .noticeContainer
                        .classList
                        .contains("cookie-revoke-visible")
                            ? (
                                t.hideRevokeNotice(),
                                t.noticeContainer.addEventListener("animationend", function e() {
                                    t
                                        .noticeContainer
                                        .removeEventListener("animationend", e),
                                    t.showCookieNotice()
                            ...
                            : t
                                .noticeContainer
                                .classList
                                .contains("cookie-notice-hidden") && t
                                .noticeContainer
                                .classList
                                .contains("cookie-revoke-hidden") && t.showCookieNotice()
                })
        }
    };
