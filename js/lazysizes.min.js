        ...
        var f = b.documentElement,
            ...
            w = function (b, c) {
                ...
                !g && (d = a.picturefill || e.pf)
                    ? (c && c.src && !b[i]("srcset") && b.setAttribute("srcset", c.src), d({
                        reevaluate: !0,
                        elements: [b]
                    }))
                    : c && c.src && (b.src = c.src)
                ...
                var g,
                    ...
                    U = function (a, c) {
                        ...
                        for (
                            ...
                            (g = (x(e, "opacity") || 1) > 0) && "visible" != x(e, "overflow") && (
                    ...
                    V = function () {
                        ...
                        if ((p = e.loadMode) && Q < 8 && (a = u.length)) {
                            for (c = 0, R++; c < a; c++) 
                                ...
                                !k && m && !j && Q < 4 && R < 4 && p > 2 && (g[0] || e.preloadAfterLoad) && (
                                    g[0] || !o && (J || I || H || G || "auto" != u[c][i](
                                        e.sizesAttr
                                    ))
                                ) && (j = g[0] || u[c]);
                            j && !k && ba(j)
                    ...
                    _ = function (a) {
                        var b,
                            c = a[i](e.srcsetAttr);
                        (b = e.customMedia[a[i]("data-media") || a[i]("media")]) && a.setAttribute(
                            "media",
                            b
                        ),
