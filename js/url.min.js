!function (t) {
    ...
    var y = /^[a-z]+:/,
        ...
        A = /^\/{2,}/,
        o = /'/g,
        e = /%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi,
        ...
        C = /[^/#?]/;
    var a,
        I = "undefined" == typeof window && "undefined" != typeof global && "function" == typeof require,
        S = I
            ? t.require
            : null,
        b = {
    ...
    function h(t, r, o) {
        ...
        if (
            ...
            t.user = z(i[1] || ""),
            t.pass = z(i[2] || ""),
            t.port = j[t.protocol] == t.port || 0 == t.port
                ? ""
                : t.port,
            !a.protocol && C.test(r.charAt(0)) && (t.path = r.split("?")[0].split("#")[0]),
            !a.protocol && o
        ) {
    ...
    function u(t) {
        return encodeURIComponent(t).replace(o, "%27")
    }
    function z(t) {
        return (t = (t = (t = t.replace(p, " ")).replace(e, function (t, r, o, e) {
            var n = parseInt(r, 16) - 224,
                i = parseInt(o, 16) - 128;
            if (0 == n && i < 32) 
                return t;
            var s = (n << 12) + (i << 6) + (parseInt(e, 16) - 128);
            return 65535 < s
                ? t
                : String.fromCharCode(s)
        })).replace(n, function (t, r, o) {
            var e = parseInt(r, 16) - 192;
            if (e < 2) 
                return t;
            var n = parseInt(o, 16) - 128;
            return String.fromCharCode((e << 6) + n)
        })).replace(i, function (t, r) {
            return String.fromCharCode(parseInt(r, 16))
        })
    }
    function F(t) {
        for (var r = t.split("&"), o = 0, e = r.length; o < e; o++) {
            var n = r[o].split("="),
            ...
            if (i) {
                ...
                void 0 === this[i]
                    ? this[i] = s
                    : (this[i] instanceof Array || (this[i] = [this[i]]), this[i].push(s))
            }
        }
    }
    function U(t, r) {
    ...
    U.prototype.paths = function (t) {
        var r,
            ...
            e = 0;
        if (t && t.length && t + "" !== t) {
            for (this.isAbsolute() && (o = "/"), r = t.length; e < r; e++) 
                t[e] = !e && s.test(t[e])
                    ? t[e]
                    : u(t[e]);
            this.path = o + t.join("/")
