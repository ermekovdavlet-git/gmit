        ...
        rules: function (command, argument) {
            ...
            if (command) {
                ...
                switch (command) {
                    ...
                    case "remove":
                        if (!argument) 
                            return delete staticRules[element.name],
                            existingRules;
                        var filtered = {};
    ...
    $.extend($.validator, {
        defaults: {
            ...
            onfocusout: function (element, event) {
                this.checkable(element) || !(element.name in this.submitted) && this.optional(
                    element
        ...
        prototype: {
            init: function () {
                ...
                function delegate(event) {
                    var validator = $.data(this[0].form, "validator"),
                        eventType = "on" + event
                            .type
                            .replace(/^validate/, "");
                    validator.settings[eventType] && validator
                        .settings[eventType]
                        .call(validator, this[0], event)
                }
                ...
                this.settings.invalidHandler && $(this.currentForm).bind(
            ...
            element: function (element) {
                ...
                var result = !1 !== this.check(element);
                return result
            ...
            showErrors: function (errors) {
                if (errors) {
                    for (var name in $.extend(this.errorMap, errors), this.errorList = [], errors) 
                        this
                            .errorList
                            .push({
            ...
            elements: function () {
                ...
                return $(this.currentForm)
                    ...
                    .filter((function () {
                        return !this.name && validator.settings.debug && window.console && console.error(
            ...
            check: function (element) {
                ...
                for (var method in rules) {
                    ...
                    try {
                        if ("dependency-mismatch" === (result = $.validator.methods[method].call(this, val, element, rule.parameters))) {
                ...
                if (!dependencyMismatch) 
                    return this.objectLength(rules) && this
                        .successList
                        .push(element),
                    !0
            },
            customDataMessage: function (element, method) {
                return $(element).data("msg-" + method.toLowerCase()) || element.attributes && $(
                    element
            ...
            formatAndAdd: function (element, rule) {
                ...
                this
                    .errorList
                    .push({message: message, element: element}),
            ...
            showLabel: function (element, message) {
                ...
                label.length
                    ...
                    : (
                        ...
                        this.settings.wrapper && (label = label.hide().show().wrap(
        ...
        classRules: function (element) {
            ...
            return classes && $.each(classes.split(" "), (function () {
                this in $.validator.classRuleSettings && $.extend(
                    rules,
        ...
        attributeRules: function (element) {
            ...
            for (var method in $.validator.methods) {
                ...
                "required" === method
                    ? (
                        "" === (value = $element.get(0).getAttribute(method)) && (value = !0),
                        value = !!value
                    )
        ...
        dataRules: function (element) {
            ...
            for (method in $.validator.methods) 
                void 0 !== (value = $element.data("rule-" + method.toLowerCase())) && (
                    rules[method] = value
                );
            return rules
        },
        ...
        methods: {
            ...
            email: function (value, element) {
                return this.optional(element) || /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$/i.test(
                    value
                )
            },
            url: function (value, element) {
                return this.optional(element) || /^(https?|s?ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(
                    value
                )
            },
            ...
            number: function (value, element) {
                return this.optional(element) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(
                    value
                )
            },
            ...
            creditcard: function (value, element) {
                ...
                for (
                    ...
                    nDigit = 0,
                    bEven = !1,
                    n = (value = value.replace(/\D/g, "")).length - 1;
                    n >= 0;
                    n--
                ) {
            ...
            equalTo: function (value, element, param) {
                var target = $(param);
                return this.settings.onfocusout && target
            ...
            remote: function (value, element, param) {
                ...
                $.ajax($.extend(!0, {
                    ...
                    success: function (response) {
                        ...
                        var valid = !0 === response || "true" === response;
                        if (valid) {
