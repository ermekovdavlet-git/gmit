...
!function (e) {
    e.fn.CodeDropz_Uploader = function (a) {
        this.each(function () {
                ...
                r = e.extend(
                    {
                        ...
                        max_file: d.data("max")
                            ? d.data("max")
                            : 10,
                        max_upload_size: d.data("limit")
                            ? d.data("limit")
                            : "10485760",
                        supported_type: d.data("type")
                            ? d.data("type")
                            : "jpg|jpeg|JPG|png|gif|pdf|doc|docx|ppt|pptx|odt|avi|ogg|m4a|mov|mp3|mp4|mpg|wav" +
                                    "|wmv|xls",
            ...
            var s = '<div class="codedropz-upload-handler"><div class="codedropz-upload-container">' +
                    '<div class="codedropz-upload-inner"><h3>' + r.text + "</h3><span>" + r.separator +
                    '</span><div class="codedropz-btn-wrap"><a class="cd-upload-btn" href="javascri' +
                    'pt:void(0)">' + r.button_text + '</a></div></div></div><span class="dnd-upload' +
                    '-counter"><span>0</span> of ' + parseInt(r.max_file) + "</span></div>";
            r
                .handler
                .wrapAll('<div class="codedropz-upload-wrapper"></div>'),
            r.supported_type = r
                .supported_type
                .replace(/[^a-zA-Z0-9| ]/g, "");
            var t = r
                    ...
                    if (!(!a.length > 1)) {
                        ...
                        e.each(a, function (a, s) {
                            if (
                                ...
                                return !e("span.has-error-msg", n).length > 0 && (
                                    err_msg = dnd_cf7_uploader.drag_n_drop_upload.max_file_limit,
                                    n.append(
                                        '<span class="has-error-msg">' + err_msg.replace("%count%", r.max_file) + "</sp" +
                                        "an>"
                                    )
                                ),
                                !1;
                            var l = i.createProgressBar(s),
                                c = !1;
                            if (
                                s.size > r.max_upload_size && (e(".dnd-upload-details", e("#" + l)).append(
                                    '<span class="has-error">' + dnd_cf7_uploader.drag_n_drop_upload.large_file + "</span>"
                                ), c = !0),
                                regex_type = new RegExp("(.*?).(" + r.supported_type + ")$"),
                                !1 !== c || regex_type.test(s.name.toLowerCase()) || (e(".dnd-upload-details", e(
                                    "#" + l
                                )).append(
                                    '<span class="has-error">' + dnd_cf7_uploader.drag_n_drop_upload.inavalid_type +
                                    "</span>"
                                ), c = !0),
                                ...
                                e.ajax({
                                    ...
                                    success: function (a) {
                                        a.success
                                            ? e.isFunction(r.on_success) && r
                                                .on_success
                                                .call(this, d, l, a)
                                            : (
                                                e(".dnd-progress-bar", e("#" + l)).remove(),
                                                e(".dnd-upload-details", e(
                                                    "#" + l
                                                )).append('<span class="has-error">' + a.data + "</span>"),
                                    ...
                                    error: function (a, d, o) {
                                        ...
                                        e(".dnd-upload-details", e("#" + l)).append(
                                            '<span class="has-error">' + r.server_max_error + "</span>"
                                        ),
                    ...
                    createProgressBar: function (a) {
                        var d = e(".codedropz-upload-handler", n),
                            r = "dnd-file-" + Math
                                ...
                                .toString(36)
                                .substr(2, 9),
                            s = '<div class="dnd-upload-image"><span class="dnd-icon-blank-file"></span></div><' +
                                    'div class="dnd-upload-details"><span class="name"><span>' + a.name + "</span><" +
                                    "em>(" + i.bytesToSize(a.size) + ')</em></span><a href="javascript:void(0)" tit' +
                                    'le="' + dnd_cf7_uploader.drag_n_drop_upload.delete.title + '" class="remove-fi' +
                                    'le" data-storage="' + o + '"><span class="dnd-icon-remove"></span></a><span cl' +
                                    'ass="dnd-progress-bar"><span></span></span></div>';
                        return d.after(
        ...
        e(document).on("click", ".dnd-icon-remove", function (d) {
            ...
            r
                .addClass("deleting")
                .text(dnd_cf7_uploader.drag_n_drop_upload.delete.text + "...");
            var p = {
                path: o
