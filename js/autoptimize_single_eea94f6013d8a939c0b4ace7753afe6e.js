(function ($) {
    ...
    wpcf7.submit = function (form) {
        ...
        var ajaxSuccess = function (data, status, xhr, $form) {
            ...
            switch (data.status) {
                ...
                case 'mail_failed':
                    ...
                    break;
                default:
                    var customStatusClass = 'custom-' + data
                        .status
                        .replace(/[^0-9a-z]+/i, '-');
        ...
        $
            .ajax({
                ...
                url: wpcf7
                    .apiSettings
                    .getRoute('/contact-forms/' + wpcf7.getId($form) + '/feedback'),
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false
    ...
    wpcf7.notValidTip = function (target, message) {
        ...
        $('<span></span>')
            .attr(
                {'class': 'wpcf7-not-valid-tip', 'role': 'alert', 'aria-hidden': 'true'}
            )
            .text(message)
            .appendTo($target);
        ...
        if (typeof data === 'undefined') {
            $
                .ajax({
                    ...
                    url: wpcf7
                        .apiSettings
                        .getRoute('/contact-forms/' + wpcf7.getId($form) + '/refill'),
    ...
    wpcf7.clearResponse = function (form) {
        ...
        $('.wpcf7-response-output', $form)
            ...
            .removeAttr('role')
            .removeClass(
                'wpcf7-mail-sent-ok wpcf7-mail-sent-ng wpcf7-validation-errors wpcf7-spam-block' +
                'ed'
            );
    };
